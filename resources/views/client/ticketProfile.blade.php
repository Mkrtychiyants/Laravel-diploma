...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body> 
        <div style="background-image: url(../../../../welcome-wallpaper-cinema.jpg);"
                ...
                <main class=" h-screen flex  flex-col gap-[11.75px] flex-wrap container mx-auto  text-md text-black ">
                    ...
                    <div class="container mx-auto  bg-orange-50/90 ">
                        ...
                        <section class="flex flex-two justify-center py-2 ">           
                            <a  href="{{route('client.GetFinalTicketQr', [$session, $finalTicket])}}" class="uppercase my-1 mx-2 rounded-md px-8 py-2 text-white font-bold text-sm  bg-teal-400">Получить код бронирования</a>
                        </section>
