                ...
                <main class="mt-6 mb-20 container mx-auto bg-gray-300 w-9/12 ">
                    <div class="grid grid-cols-1">
                        ...
                        <section class="container mx-auto ">
                            ...
                            <div class="px-20 container relative mx-auto">
                                          ...
                                          {{-- @foreach ($movies as $movie)
                                                    <a href="{{route('createSeansForMovie', $movie->id)}}" class="bg-amber-200 flex flex-row justify-start items-center gap-2 w-48 h-14 rounded-md border-2" >
                                                        <div class="bg-gray-50 text-black/50 size-14 ">
                                                            <img src="/public/movies/{{ $movie->thumbnail}}"> 
                                                        </div>
                                ...
                                <div class="flex flex-two container mx-auto justify-center p-6">           
                                                ...
                                                <a  href="{{ route( 'admin.homepage') }}" class="uppercase  rounded-md px-8  py-3 text-white font-bold text-sm  bg-emerald-700 shadow-lg hover:bg-emerald-500 transition-all ease-in  delay-300  duration-200">сохранить</a>
                                </div>
                        ...
                        <section class="container mx-auto ">
                            ...
                            <div class="px-20 container relative mx-auto">
                                <div class="flex flex-col text-black items-center p-6 my-4  text-lg">
                                    <p class="mb-4">Всё готово, теперь можно:</p>
                                <a  href="{{route('client.SessionsList', \Carbon\Carbon::now('Europe/Moscow')->locale('ru_RU')->format('Y-m-d'))}}"  class="uppercase  rounded-md px-8  py-3 text-white font-bold text-sm  bg-emerald-700 shadow-lg hover:bg-emerald-500  transition-all ease-in  delay-300  duration-200" >открыть продажу билетов</a>
                                </div>
                            </div>
                        </section>
                    </div>
