        ...
        class="min-h-screen w-full bg-cover bg-no-repeat min-w-[700px] ">
                ...
                <main class="mt-6 mb-20 container mx-auto bg-gray-300 w-9/12 ">
                    <div class="grid grid-cols-1">
                        ...
                        <section class="container mx-auto ">
                            <a  href="{{ route('admin.roomPricesConfiguration') }}" class="relative" >
                        ...
                        <section class="container mx-auto ">
                            ...
                            <div class="px-20 container relative mx-auto">
                                ...
                                <a  href=""  class="uppercase  rounded-md px-8  py-3 text-white font-bold text-sm  bg-emerald-700 shadow-lg hover:bg-emerald-500  transition-all ease-in  delay-300  duration-200" >открыть продажу билетов</a>
                                </div>
                            </div>
                        </section>
                    </div>
